      ...
      <div className="w-full max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 grid grid-cols-1 md:grid-cols-2 gap-12 md:gap-16 items-center">
        ...
        <div className="flex flex-col gap-6 md:gap-8">
          <div className="flex items-center gap-4">
            <span className="font-medium text-[14px] md:text-[17px] tracking-[-0.005em] text-[#777777] dark:text-gray-300">Watch Demo</span>
            <a href="" className="flex items-center justify-center w-[125px] h-[50px] border border-gray-300 dark:border-gray-700 rounded-md hover:bg-gray-50 dark:hover:bg-gray-800 transition-colors">
        ...
        <div className="flex flex-col gap-4 text-left items-start md:text-right md:items-end">
          <p className="font-normal text-[14px] md:text-[17px] leading-[150%] tracking-[-0.005em] text-[#777777] dark:text-gray-300 w-full max-w-[389px] whitespace-pre-line">
            {'The AI co-pilot for hardware engineers. \nAutomate schematic design and go from idea to\n production-ready files faster than ever before.'}
          </p>
          <a 
            href=""
