...
const PricingIcon: React.FC<IconProps> = ({ color = "#292D32" }) => (
    <svg width="24" height="24" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
        <path opacity="0.8" d="M12.9002 2.52009L12.8702 2.59009L9.9702 9.32009H7.1202C6.4402 9.32009 5.8002 9.45009 5.2002 9.71009L6.9502 5.53009L6.9902 5.44009L7.0502 5.28009C7.0802 5.21009 7.1002 5.15009 7.1302 5.10009C8.4402 2.07009 9.9202 1.38009 12.9002 2.52009Z" fill={color} />
...
const CareersIcon: React.FC<IconProps> = ({ color = "#292D32" }) => (
    <svg width="24" height="24" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
        <path opacity="0.4" d="M9 2C6.38 2 4.25 4.13 4.25 6.75C4.25 9.32 6.26 11.4 8.88 11.49C8.96 11.48 9.04 11.48 9.1 11.49C9.12 11.49 9.13 11.49 9.15 11.49C9.16 11.49 9.16 11.49 9.17 11.49C11.73 11.4 13.74 9.32 13.75 6.75C13.75 4.13 11.62 2 9 2Z" fill={color} />
        <path d="M14.08 14.1499C11.29 12.2899 6.73996 12.2899 3.92996 14.1499C2.65996 14.9999 1.95996 16.1499 1.95996 17.3799C1.95996 18.6099 2.65996 19.7499 3.91996 20.5899C5.31996 21.5299 7.15996 21.9999 8.99996 21.9999C10.84 21.9999 12.68 21.5299 14.08 20.5899C15.34 19.7399 16.04 18.5999 16.04 17.3599C16.03 16.1299 15.34 14.9899 14.08 14.1499Z" fill={color} />
        ...
        >
            ...
            <div className={`w-[36px] h-[36px] flex items-center justify-center rounded-[4px] border-[0.5px] transition-colors ${isActive ? 'bg-white border-[#DDE2FF]' : 'bg-white border-[#EEEEEE]'}`}>
                <div className="relative w-[24px] h-[24px]">
                    <Icon color={isActive ? "#0038DF" : "#292D32"} />
                </div>
            </div>
