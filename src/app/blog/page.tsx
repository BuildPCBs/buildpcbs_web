          ...
          <div className="lg:w-4/5">
            <div>
              {posts.map((post) => (
                <article
                  key={post.id}
                  className="flex w-full max-w-[802px] border-b border-gray-200 dark:border-gray-700 pb-8 mb-8 cursor-pointer hover:bg-gray-50 dark:hover:bg-gray-900 active:bg-gray-50 dark:active:bg-gray-900 transition-colors duration-200"
                >
                  <div className="flex flex-col justify-between flex-grow">
                    <div>
                      ...
                      <h2 className="text-[20px] lg:text-[32px] font-medium lg:font-normal text-[#444444] dark:text-white mb-4 leading-none tracking-[-0.005em] lg:tracking-[-0.02em]">
                        {post.title}
                      </h2>
                      <p className="text-[14px] text-gray-600 dark:text-gray-300 mb-6 leading-[1.35] tracking-[0.01em]">
                        {post.excerpt}
                      </p>
                    </div>
                    <div className="flex items-center">
